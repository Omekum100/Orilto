      ...
      <section className="section-tight">
        <div className="container case-study-layout">
          <aside className="toc" aria-label="Case study sections">
            {["Summary", "Context", "Problem", "Constraints", "Direction", "Contribution", "Experience", "Architecture", "Delivered", "Evidence", "Opportunities", "Services"].map((item) => <p key={item}>{item}</p>)}
          </aside>
          <article>
